...
public class Test_answer_j { // 소문자 말고 대문자 써라..ㅜ
				...
				if(menu == 4) {			//4. 게임 종료
					...
					while(true) {
						try {
							...
							System.out.println("충전 액수를 정확히 입력해주세요.");        	
						}
					}
					...
					while(true) {
						...
						while(true) {
							try {
								...
								System.out.println("배팅 하고 싶은 말을 정확히 선택해주세요.");        	
							}
						}
						...
						if(player == 1 || player == 2 || player == 3) {
							...
							while(true) {
								try {
									...
									System.out.println("배팅 하고 싶은 액수를 정확히 입력해주세요.");        	
								}
							}
