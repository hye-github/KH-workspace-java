...
public class Study {
   ...
   public static void main(String[] args) {
      //자판기
      //1콜라1000 2 사이다 800 3 메실차 1500 [0] 소지품 확인]
      //
      ...
      System.out.println("초기 소지금을 입력하세요");
      int balance =Integer.parseInt(sc.nextLine());
      while(true) {

      System.out.println("====자판기 시뮬레이터====");
      System.out.println("1. 콜라(1000) 2. 사이다(800) 3.메실차(1500) 4.되돌아가기 [0.소지품 확인]");
      ...
      if(input ==1) {
       ...
       if(input==2) {
          if(balance>=ci) {
             System.out.println("사이다를 구매하였습니다");
       ...
       if(input==3) {
          if(balance>=pl) {
             System.out.println("메실을 구매하였습니다");
             System.out.println("메실+1");
             System.out.println("소지금 "+"-"+pl);
             plum++;
             balance-=pl;
          }else {
            System.out.println("잔고 부족입니다");
         ...
         if(input==4) {
            System.out.println("구매를 취소 하였습니다");
            break;
         }
      }
