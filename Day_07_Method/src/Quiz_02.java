...
// 걱정 이유. 1000보다 작은 i 값이 999까지만 되는데 이후에 i+1, i+2, i+3 이 되면 index값이 넘어가서 오류가 생김
// 운이 좋았음. 어지간해선 에러가 안나는데 끝에 J로 끝나면 구동이 안됨. 조건이 안맞으니까 shortcut
// 앞이 J 이면 트루 / 뒤는 1000이어도 shortcut 으로 없어짐
